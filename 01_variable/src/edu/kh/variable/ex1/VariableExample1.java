...
public class VariableExample1 {
	// 생성된 자바파일과 클래스 오른쪽에 작성된 이름은 똑같아야한다
	
	public static void main(String[] args) {
		System.out.println(2 * 3.141592653589793 * 5);
		System.out.println(5 * 3.141592653589793 * 5);
		System.out.println(5 * 3.141592653589793 * 5 * 20);
		 ...
		 * -> 공간에 기록되는 값이(DATA) 변할 수 있어서 변수라고한다.
		...
		System.out.println(r * pi * r); // 원의 넓이
		System.out.println(r * pi * r * h); // 원기둥의 부피
